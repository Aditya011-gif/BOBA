    ...
    return Card(
      ...
      child: CheckboxListTile(
        ...
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('${nft.landDetails.areaInAcres} acres • ${nft.landDetails.landType}'),
            Text(
    ...
    return Card(
      ...
      child: CheckboxListTile(
        ...
        subtitle: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('${nft.harvestData.quantity} ${nft.harvestData.unit} • ${nft.qualityAssurance.qualityGrade} Grade'),
            Text(
